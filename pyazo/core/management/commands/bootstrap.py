...
class Command(BaseCommand):
    """Bootstrap pyazo, ensure Database and Cache are reachable, and directories are writeable"""

    help = "Bootstrap pyazo, ensure Database and Cache are reachable, and directories are writeable"
